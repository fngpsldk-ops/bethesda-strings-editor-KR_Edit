...
_FIELD_DEFS: list[tuple[str, str, int, bool, int]] = [
    ...
    # ("CNAM", "DOOR", 0, False, 0),  # REMOVED — actually holds an animation
    # resource path in practice (confirmed: rbt_RealFuel_RE.esm), not text.
...
def _looks_like_resource_path(text: str) -> bool:
    """Heuristic: does this look like a resource path rather than player text?"""
