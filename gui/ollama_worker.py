...
class TranslationRequest:
    ...
    def to_system_prompt(self) -> str:
        ...
        base = (
            ...
            "3. Square brackets []: translate ALL content inside them — "
            "dialogue choices, narrative notes, publisher notes, editorial remarks. "
            "Keep the brackets. Only preserve short game-engine codes intact: "
            "[PLYR], [MALE], [FEMALE], [Firstname], [Secondname], [F], [M]. "
