...
class TranslationRequest:
    ...
    def to_system_prompt(self) -> str:
        ...
        base = (
            ...
            "[Diplomacy]→[Дипломатія], [Distraction]→[Відволікання], [Extortion]→[Вимагання], "
            "[Piracy]→[Піратство], [Romance]→[Романтика], [Lethal]→[Летально], [Sneak]→[Крадіжка].\n"
            "   b) PRESERVE unchanged — input-binding tokens (map to keyboard/gamepad keys): "
            "[Attack], [AltAttack], [SecondaryAttack], [PrimaryAttack], [Jump], [Sprint], [Back], "
            ...
            "[QuickInventory], [SelectTarget], [NextTarget], [PrevTarget], [TakeOff], [Sprint], "
            ...
            "[WeaponReadyReload], [Space], [Mouse2], and all similar single-action bindings.\n"
            ...
            "   d) TRANSLATE ALL-CAPS status/document codes to target-language equivalent: "
